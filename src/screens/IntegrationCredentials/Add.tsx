...
import { addIntCredential, INT_CREDENTIAL_TYPE_INSTAGRAM, INT_CREDENTIAL_TYPE_LINKEDIN, INT_CREDENTIAL_TYPE_TWITTER, type NewIntCredentialData } from '../../api/intCredentials';
...
export function Add() {
  ...
  async function handleOnSave() {
      ...
      const data = await addIntCredential(payload);
